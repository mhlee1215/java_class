 ...
 *  @author Kevin Wayne
 */
public class StdDraw extends Thread implements ActionListener, MouseListener, MouseMotionListener, KeyListener {
	...
	static double rx = 0.480, ry = 0.860;     // position
	static int mapX = 30;
	static int mapY = 30;
	static int[][] map = null;//new int[mapX][mapY];
	static Point blockP = new Point(mapX/2, mapY-1);
	double radius = 0.05;              // radius

	public static int MOVE_PREV = 0;
	...
	public Point2D map2Visual(double x, double y){
		return new Point2D.Double((2*x-map.length)/mapX , (2*y-map.length)/mapY);
	}
	...
	public static void main(String[] args) {
		...
		StdDraw game = new StdDraw();
		game.start();

		//System.out.println(game.map2Visual(99, 99));
